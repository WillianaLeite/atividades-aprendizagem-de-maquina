from models.KNeighborsClassifier import *
from models.DMCClassifier import * 
from src import metrics, utils

def _get_model(model_name, n_neighbors=5):
    if model_name == 'knn':
        return KNeighborsClassifier(n_neighbors=n_neighbors)
    elif model_name == 'dmc':
        return DMCClassifier()
...
def pipeline(df,
    ...
    for i in range(1, n_realizations+1):
        ...
        model = _get_model(model_name, n_neighbors)
